...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.corners = [(1,1), (1,top), (right, 1), (right, top)] # changed to list so easier to remove items
...
def cornersHeuristic(state, problem):
    ...
    while unvisitedCorners != []:
        manDist = [] # list of tuples (manhattanDistance, corner)
        for corner in unvisitedCorners:
            manDist.append((util.manhattanDistance(corner,currentState),corner))
        minDist, closestCorner = min(manDist)
        heuristic += minDist
